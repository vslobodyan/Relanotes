...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_7 = QtWidgets.QLabel(self.frameNotelist_Filter)
        self.label_7.setMaximumSize(QtCore.QSize(40, 40))
        self.label_7.setText("")
        self.label_7.setPixmap(QtGui.QPixmap(":/newPrefix/icons/document7-4.svg"))
        ...
        self.lineNotelist_Filter.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.horizontalLayout.addWidget(self.lineNotelist_Filter)
        ...
        self.horizontalLayout.addWidget(self.lineEdit_Filter_Note_Text)
        ...
        self.textBrowser_Note.setTextInteractionFlags(QtCore.Qt.TextEditorInteraction)
        self.textBrowser_Note.setOpenExternalLinks(False)
        self.textBrowser_Note.setOpenLinks(False)
        ...
        self.frame_NoteMinimap.setMinimumSize(QtCore.QSize(16, 0))
        ...
        self.label_8 = QtWidgets.QLabel(self.frameSearchInNote)
        self.label_8.setMaximumSize(QtCore.QSize(30, 30))
        self.label_8.setText("")
        self.label_8.setPixmap(QtGui.QPixmap(":/newPrefix/icons/dark37.svg"))
        ...
        self.label_4 = QtWidgets.QLabel(self.frameSearchInNote)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1017, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:13pt; color:#008066;\">List of your notes</span></p></body></html>"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Name or contents</p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "       Include text"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:13pt; color:#008066;\">Search in your note</span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p>What to find:</p></body></html>"))
