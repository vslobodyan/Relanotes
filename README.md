...
ѕерейти в поиск из заметки: ```Ctrl+J```, и ¬ы сразу окажетесь в поле поиска.
«атем наберите слово с пробелом в начале дл€ поиска по содержимому заметок:
...
»ли слово без пробела дл€ поиска по названию (или пути) заметки:
