...
## ∆ивой поиск по списку заметок

ћгновенный поиск по имени и содержимому заметки из одного пол€.
ѕерейти в поиск из заметки: Ctrl+J
¬ы сразу окажетесь в поле поиска.
Ќаберите слово с пробелом в начале дл€ поиска по содержимому заметок:
 * ```_ ninja``` найдет все заметки, в которых есть упоминание ninja.
 * ```projects ninja``` найдет все заметки, в пути или названии которых есть projects, и в которых есть упоминание ninja.

—лово без пробела - поиск по названию (или пути) заметок:
 * ```proj``` найдет все заметки с именами projects, proj. и т.д.

 ≈сли поставить 2 пробела в начале, то произойдет поиск по всем заметкам, в которых указанному слову предшествует пробел.


 ## Ѕлокировка интерфейса - защита от детей и питомцев

 „асто в семь€х присутствует проблема - компьютер нельз€ оставить без присмотра ни на минуту!
 Ќа его клавиатуре и мышке тут-же потопает или щенок, или маленький ребенок, и все написанное может быть безнадежно потер€но или испорчено.

 ¬ Relanotes есть специальный режим быстрой блокировки интерфейса если в программе ничего не делают 60 секунд (или 30, или как захотите)!
 ¬ы включаете этот режим, и работаете спокойно, отвлека€сь на домашние дела, на детей и на всЄ что захотите!
 ѕрограмма надежно защитит вашу информацию от изменени€. ѕри этом вы легко продолжите работать, нажав быструю секретную комбинацию клавиш!
 » не надо волноватьс€ - сохранила ли программа ваши изменени€.  онечно да!
